...
def idf_score(no_of_sentences, word, sentences):
    ...
    idf = math.log(no_of_sentences/no_of_sentence_containing_word)
    return idf
...
def tfidf_func(file_in=open('Data/the-cactus.txt', 'r'), percent_in=50, idlSummary=open('Data/res.txt').read()):
    text = file_in.read()
    ...
    no_of_sentences = int((percent_in * len(tokenized_sentence))/100)
